...
public class X2State {
    ...
    protected Exception savedException; //TODO
    ...
    public X2StateType getStateType() { return stateType; }
    ...
    {
        if(stateType != X2StateType.TEXT &&
           stateType !=  X2StateType.CDSECT &&
           stateType !=  X2StateType.ENTITY_REF &&
           stateType !=  X2StateType.IGNORABLE_WHITESPACE &&
...
//      }
    ...
    public int getLen() {
        ...
        //              "must be on text to get length", iter.XmlPullParser, null);
        //      }
        if(stateType != X2StateType.TEXT &&
           stateType !=  X2StateType.CDSECT &&
           stateType !=  X2StateType.ENTITY_REF &&
...
//      if(stateType != X2StateType.EXCEPTION) {
//          throw new IllegalArgumentException();
//      }
//      savedException = ex;
//    }
...
//    }
    ...
    // --- namespaces
    public int getNamespacesLength() { return nsEnd; }
    ...
    // -- attributes
    public int getAttributesLength() { return attrsEnd; }
                             ...
                             String type)
    {
        ...
        if(attrsEnd >= attrs.length) {  //should never happen if setAttributesLength()
